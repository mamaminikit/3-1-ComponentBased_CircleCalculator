 ...
 * @mmmaimankarae
 */
@WebServlet(name = "CalculatorCircle", urlPatterns = {"/CalculatorCircle"})
public class CalculatorCircle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>sever027_CalculatorCircleServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            } else if ("Perimeter".equals(action)) { // Check for "Perimeter" here
                out.println("<h1>For the circle with radius = " + radius + " </h1>");
